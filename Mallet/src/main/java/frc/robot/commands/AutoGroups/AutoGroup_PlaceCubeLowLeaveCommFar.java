...
public class AutoGroup_PlaceCubeLowLeaveCommFar extends SequentialCommandGroup {
    //Variables
    public AutoGroup_PlaceCubeLowLeaveCommFar(Drivetrain drivetrain, GyroScope gyro, IntakeSub m_intake, ExtensionSubPID m_extensionMotor, PivotSubPID m_pivotMotor){
