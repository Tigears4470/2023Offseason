...
public class AutoGroup_PlaceCubeMidLeaveCommClose extends SequentialCommandGroup {
    //Variables
    public AutoGroup_PlaceCubeMidLeaveCommClose(Drivetrain drivetrain, GyroScope gyro, IntakeSub m_intake, ExtensionSubPID m_extensionMotor, PivotSubPID m_pivotMotor){
