...
public class AutoGroup_PlaceCubeMidLeaveCommClose extends SequentialCommandGroup {
    // Variables
    public AutoGroup_PlaceCubeMidLeaveCommClose(Drivetrain drivetrain, GyroScope gyro, IntakeSub m_intake,
        ...
        addCommands(
                ...
                new PivotMoveToAngleWait(m_pivotMotor, Constants.K_ANGLE_AUTO_MID),
                Commands.deadline(new WaitCommand(3), new MoveDistance(drivetrain, Constants.K_MOVE_AUTO_MID, false),
                        new ExtenderSetPositionWait(m_extensionMotor, Constants.K_EXT_AUTO_MID)),
                ...
                Commands.parallel(new AutoGroup_LowerPivot(m_pivotMotor),
                        new MoveDistance(drivetrain, Constants.K_LEAVE_COMMUNITY_FAR, true)) // Leave community
                                                                                             // afterwards
        );
    }
}