...
public class AutoGroup_PlaceCubeLowLeaveCommClose extends SequentialCommandGroup {
    //Variables
    public AutoGroup_PlaceCubeLowLeaveCommClose(Drivetrain drivetrain, GyroScope gyro, IntakeSub m_intake, ExtensionSubPID m_extensionMotor, PivotSubPID m_pivotMotor){
