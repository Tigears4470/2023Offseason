...
public class AutoGroup_PlaceCubeHighLeaveCommClose extends SequentialCommandGroup {
    //Variables
    public AutoGroup_PlaceCubeHighLeaveCommClose(Drivetrain drivetrain, GyroScope gyro, IntakeSub m_intake, ExtensionSubPID m_extensionMotor, PivotSubPID m_pivotMotor){
        ...
        addCommands(
            ...
            new MoveDistance(drivetrain, Constants.K_LEAVE_COMMUNITY_CLOSE, true)) // Leave community afterwards
        );
    }
}