...
public class AutoGroup_PlaceCubeMid extends SequentialCommandGroup {
    //Variables
    public AutoGroup_PlaceCubeMid(Drivetrain drivetrain, GyroScope gyro, IntakeSub m_intake, ExtensionSubPID m_extensionMotor, PivotSubPID m_pivotMotor){
