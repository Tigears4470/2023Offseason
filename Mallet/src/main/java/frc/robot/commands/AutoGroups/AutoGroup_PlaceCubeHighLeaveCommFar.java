...
public class AutoGroup_PlaceCubeHighLeaveCommFar extends SequentialCommandGroup {
    // Variables
    public AutoGroup_PlaceCubeHighLeaveCommFar(Drivetrain drivetrain, GyroScope gyro, IntakeSub m_intake,
        ...
        addCommands(
                ...
                Commands.parallel(
                        Commands.race(new WaitCommand(4.5),
                                new MoveDistance(drivetrain, Constants.K_MOVE_AUTO_HIGH, false)),
                ...
                Commands.parallel(new AutoGroup_LowerPivot(m_pivotMotor),
                        new MoveDistanceFast(drivetrain, Constants.K_LEAVE_COMMUNITY_FAR, true)) // Leave community
                                                                                                 // afterwards
        );
    }
}