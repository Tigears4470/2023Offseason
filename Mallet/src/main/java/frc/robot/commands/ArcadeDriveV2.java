...
public class ArcadeDriveV2 extends CommandBase {
  ...
  public void execute() {
    ...
    //Sensitivity is based on the third axis, aka the dial at the base of the joystick 
    m_drivetrain.arcadeDrive(-1.0 *m_joystick.getRawAxis(2) * m_joystick.getRawAxis(1), -1.0 * m_joystick.getRawAxis(2) * m_joystick.getRawAxis(0));
  }
